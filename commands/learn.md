---
description: "Save a lesson as a personal genprompt rule in ~/.genprompt/local-rules.md (shows the diff first)"
argument-hint: "<rule or lesson>"
...
@${CLAUDE_PLUGIN_ROOT}/utilities/learn.md
@${CLAUDE_PLUGIN_ROOT}/guide/00-index.md
