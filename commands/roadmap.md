---
description: "Generate a roadmap/backlog-execution prompt (drive a whole backlog doc to done)"
argument-hint: "drive <doc> to done   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/I-roadmap.md
