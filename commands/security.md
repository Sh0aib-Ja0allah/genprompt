---
description: "Generate a security prompt: threat model, authz/uploads/secrets/headers review, then safe fixes"
argument-hint: "<area | whole app>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/Q-security.md
