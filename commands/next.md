---
description: "Generate the NEXT prompt from a pasted worker stop-report (or a closeout if nothing is left)"
argument-hint: "<paste the worker's report, or nothing if it is already in the chat>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/J-next.md
