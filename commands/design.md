---
description: "Generate a design prompt: ADR, API contract, schema/ERD, design-system mapping or spike (no production code)"
argument-hint: "<ADR | API contract | schema | design system | spike>: <decision>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/N-design.md
