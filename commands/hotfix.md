---
description: "Generate a hotfix prompt for a live incident: triage, mitigate, root cause, regression test, postmortem"
argument-hint: "<symptom, since when, who is affected>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/U-hotfix.md
