---
description: "Generate a resume-after-compaction prompt (rebuild lost worker context, then continue)"
argument-hint: "<unit/slice the worker was mid-way through>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/K-resume.md
