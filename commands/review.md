---
description: "Generate a code-review prompt for a diff, branch, PR or recent commits (findings only, no edits)"
argument-hint: "<base..head | branch | PR number | last N commits>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/P-review.md
