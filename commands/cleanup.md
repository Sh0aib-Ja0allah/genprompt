---
description: "Generate a cleanup prompt: dead code, feature removal, restore-green, refactor with no behaviour change"
argument-hint: "<dead code | removal | restore-green | refactor target>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/V-cleanup.md
