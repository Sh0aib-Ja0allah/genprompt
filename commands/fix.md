---
description: "Generate a defect-driven fix prompt (per-defect repro, acceptance, false positives)"
argument-hint: "<defect list, or the audit/report that found them>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/L-fix.md
