---
description: "Generate an approval/rulings prompt: lock decisions, rule on findings, or amend a sent prompt"
argument-hint: "decisions: <list>; order: <...>  |  amend <prior prompt>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/E-approve.md
