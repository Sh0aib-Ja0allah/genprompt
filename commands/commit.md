---
description: "Generate a commit-and-push prompt for a scoped body of work (or verify-then-commit)"
argument-hint: "<work to commit> [verify+]   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/H-commit.md
