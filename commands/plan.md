---
description: "Generate a planning-only prompt (one plan doc with stable ids, no code)"
argument-hint: "<unit> <backend|frontend|cross-repo>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/F-plan.md
