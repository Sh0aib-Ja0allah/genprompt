---
description: "Generate a kickoff prompt for a unit with uncommitted WIP in the tree"
argument-hint: "<unit to start>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/C-kickoff.md
