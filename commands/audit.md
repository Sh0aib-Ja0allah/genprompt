---
description: "Generate a read-only audit prompt (one doc with a ranked backlog, no code)"
argument-hint: "<area to assess>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/B-audit.md
