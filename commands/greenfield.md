---
description: "Generate a greenfield prompt that studies a reference repo first, then builds"
argument-hint: "<layer> studying <reference repo>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/G-greenfield.md
