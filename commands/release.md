---
description: "Generate a release/deploy prompt: version, changelog, runbook, smoke, rollback, approval per action"
argument-hint: "<version | environment | handover>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/T-release.md
