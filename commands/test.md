---
description: "Generate a test-engineering prompt: write missing tests, fix vacuous/flaky tests, build a harness"
argument-hint: "<area | coverage target | flaky or vacuous tests>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/O-test.md
