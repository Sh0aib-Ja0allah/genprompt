---
description: "Generate a slice-execution prompt (one vertical slice, with checkpoints)"
argument-hint: "Slice <ID>, scope: <bullets>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/D-slice.md
