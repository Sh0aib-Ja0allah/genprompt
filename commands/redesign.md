---
description: "Generate a senior-level redesign/refactor prompt for one file (screen, component, module)"
argument-hint: "<file path> (<screen|dialog|component|module>)   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/A-redesign.md
