---
description: "Generate an onboarding prompt: map an unfamiliar or empty repo and draft its CLAUDE.md contract"
argument-hint: "[repo]   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/M-onboard.md
