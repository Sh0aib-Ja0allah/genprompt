---
description: "Generate a documentation prompt: README, API docs, runbooks, admin/handover guides checked against code"
argument-hint: "<doc> for <audience>   [--repo <name|path>] [--go] [--attended|--unattended] [--dry-run] [--brief] [--follows <file>]"
...
@${CLAUDE_PLUGIN_ROOT}/archetypes/W-docs.md
